...
public class CharacterCreatorController {
	...
	@GetMapping("/helloCharacterCreator")
	public String helloWorld() {
		String a = "This is a controller test about creating characters for a game! ";
		String b = "This is a second paragraph";
		return a + b;
	}

	@GetMapping("/demoCharacterCreator")
	public CharacterCreator getDemoCharacterCreator() {
		return new CharacterCreator("Magman", "Fireball", 5000, 950, 1100, 850, 1500, 2100);
	}
	...
	public CharacterCreator getById(@PathVariable Integer id) {
