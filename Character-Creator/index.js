    ...
    axios.get("http://localhost:8080/getCharacterCreator")
        .then(res => {
            ...
            for (let characterCreator of res.data) {
                ...
                const characterCreatorName = document.createElement("h2");
                characterCreatorName.innerText = characterCreator.name;
                characterCreatorDiv.appendChild(characterCreatorName);

                const characterCreatorSpecialAbility = document.createElement("p");
                characterCreatorSpecialAbility.innerText = "Special Ability: " + characterCreatorSpecialAbility.specialAbility;
...
const deleteCharacterCreator = (id) => {
